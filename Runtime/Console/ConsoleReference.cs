...
namespace Smidgenomics.Unity.Console
{
	...
	{
		public bool IsSet => _asset;
		public IConsole Console => _asset;
		[SerializeField] internal ConsoleAsset _asset;
	}
}
...
namespace Smidgenomics.Unity.Console.Editor
{
	...
	internal sealed class _ConsoleReference : PropertyDrawer
	{
		public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent l)
		{
			EditorGUI.BeginProperty(pos, l, prop);
			{
				...
				var cprop = prop.FindPropertyRelative(nameof(ConsoleReference._asset));
